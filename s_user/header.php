...
<body class="app">   	
  ...
  <path fill-rule="evenodd" d="M8 1.918l-.797.161A4.002 4.002 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4.002 4.002 0 0 0-3.203-3.92L8 1.917zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99 0A5.002 5.002 0 0 1 13 6c0 .88.32 4.2 1.22 6z"/>
</svg><span class="icon-badge">3</span></a><!--//dropdown-toggle--></div><!--//app-utility-item-->		            
	...
	<li class="nav-item">
						...
						<a class="nav-link" href="./malipo/index.html">
							<span class="nav-icon">
						...
						<a class="nav-link" href="./ahadi/index.html">
							<span class="nav-icon">
								<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-folder" fill="currentColor"
									xmlns="http://www.w3.org/2000/svg">
									<path
							...
							<span class="nav-link-text">Ahadi & familia</span>
						</a> </li>

						<a class="nav-link" href="./idara/index.html">
							<span class="nav-icon">
								<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-folder" fill="currentColor"
									xmlns="http://www.w3.org/2000/svg">
									<path
							...
							<span class="nav-link-text">idara (vitengo)</span>
						</a> </li>
					...
					<li class="nav-item">
						<a class="nav-link" href="orders.html">
							...
							<span class="nav-link-text">Zawadi</span>
						</a></li><!--//nav-item-->
						...
						<li class="nav-item">
							<a class="nav-link" href="charts.html">
								...
								<span class="nav-link-text">Kamati </span>
							</a>
						</li><!--//nav-item-->
					...
					<li class="nav-item has-submenu">
						<a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-2"
							...
							<span class="nav-link-text">Michango</span>
						...
						<div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
							<ul class="submenu-list list-unstyled">
								<li class="submenu-item"><a class="submenu-link" href="#">Ahadi</a></li>
								<li class="submenu-item"><a class="submenu-link" href="#">Kadi za mwaliko</a></li>
								<li class="submenu-item"><a class="submenu-link" href="#">kamati</a></li>
				...
				<li class="nav-item has-submenu">
						<a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-1"
							...
							<span class="nav-link-text">Bajeti & Matumizi</span>
							<span class="submenu-arrow">
								<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chevron-down" fill="currentColor"
									xmlns="http://www.w3.org/2000/svg">
									<path fill-rule="evenodd"
						...
						<div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
							<ul class="submenu-list list-unstyled">
								<li class="submenu-item"><a class="submenu-link" href="#">Bajeti</a></li>
								<li class="submenu-item"><a class="submenu-link" href="#">Matumizi</a></li>
								<!-- <li class="submenu-item"><a class="submenu-link" href="#">Settings</a></li> -->
							</ul>
						</div>
					</li>
					<li class="nav-item">
					...
					<ul class="app-menu footer-menu list-unstyled">
						<li class="nav-item">
							<a class="nav-link" href="settings.html">
								...
								<span class="nav-link-text">Hariri akaunti</span>
							</a><!--//nav-link-->
						</li><!--//nav-item-->
						...
						<li class="nav-item">
							<a class="nav-link"
								...
								<span class="nav-link-text">Term and Condition</span>
							</a><!--//nav-link-->
						</li><!--//nav-item-->
						...
						<li class="nav-item">
							<a class="nav-link"
								...
								<span class="nav-link-text">DMK IT SERVICES</span>
							</a><!--//nav-link-->
						</li><!--//nav-item-->
					</ul><!--//footer-menu-->
				</nav>
